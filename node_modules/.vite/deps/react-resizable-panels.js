...
var te;
function ft() {
  return te === void 0 && (typeof matchMedia == "function" ? te = !!matchMedia("(pointer:coarse)").matches : te = false), te;
}
function dt(e) {
...
var mt = /\b(?:position|zIndex|opacity|transform|webkitTransform|mixBlendMode|filter|webkitFilter|isolation)\b/;
function ht(e) {
...
function ze(e) {
  ...
  n.forEach((a) => {
    o.add(a.group), a.panels.forEach((f) => {
      r.add(f);
    }), a.separator && (s.add(a.separator), i || (i = true, a.separator.element.focus()));
...
function Fe({
  ...
  n.forEach((a) => {
    ...
    const d = o.get(u), {
      ...
      layout: S,
      separatorToPanels: x
    } = r.get(u) ?? { defaultLayoutDeferred: false };
    if (v && d && S && x) {
      const g = Y({
        delta: c,
        initialLayout: d,
...
var je = "--react-resizable-panels--panel--pointer-events";
function He(e, t) {
...
function Tt({
  ...
  const m = (0, import_react.useRef)({}), h = ce((L) => {
    K(m.current, L) || (m.current = L, a?.(L));
  }), c = ue(i), [d, y] = (0, import_react.useState)(false), v = (0, import_react.useRef)(null), [S, x] = (0, import_react.useState)(n ?? {}), [g, b] = (0, import_react.useState)([]), [w, C] = (0, import_react.useState)([]), $ = (0, import_react.useRef)({
    lastExpandedPanelSizes: {},
    layouts: {}
  }), oe = fe(v, s);
  Pt(c, l);
  const Z = (0, import_react.useMemo)(
    () => ({
      id: c,
      orientation: u,
  ...
  return (0, import_jsx_runtime.jsx)(Ve.Provider, { value: Z, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...p,
      "aria-orientation": u,
...
function _t({
  ...
  const r = t !== void 0, s = "id" in o ? o.id : o.groupId, l = re(s, t ?? []), i = (0, import_react.useSyncExternalStore)(
    Ct,
    () => n.getItem(l),
    () => n.getItem(l)
...
function de() {
  const e = (0, import_react.useContext)(Ve);
  return z(
    e,
...
function Mt(e, t) {
  const { id: n } = de(), o = (0, import_react.useRef)({
    collapse: ie,
    expand: ie,
    getSize: () => ({
      asPercentage: 0,
...
function $t({
  ...
  const h = !!l, c = ue(l), d = (0, import_react.useRef)(null), y = fe(d, s), { id: v, registerPanel: S } = de(), x = u !== null, g = ce(
    (w, C, $) => {
      u?.(w, l, $);
    }
  );
...
function Ht({
  ...
  const l = ue(o), [i, a] = (0, import_react.useState)({}), [u, f] = (0, import_react.useState)("inactive"), [p, m] = (0, import_react.useState)(null), h = fe(m, n), {
    id: c,
    orientation: d,
    registerSeparator: y
  ...
  }, [p, c, l, y]), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...s,
